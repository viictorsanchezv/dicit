...
function RightScrollTop({options}: { options?: gsap.TweenVars }) {
    ...
    useEffect(() => {
       ...
       const trigger =  ScrollTrigger.create({
            trigger: wrap,
            animation: gsap.to(svg.current, 0.3, {rotation: wrap.scrollHeight / 2}),
            start: '+=350',
        ...
        function Show() {
            gsap.to(scroll.current, 1, {right: 10, autoAlpha: 1});
        }

        function Hide() {
            gsap.to(scroll.current, 1, {right: -100, autoAlpha: 0});
        }
    ...
    useEffect(() => {
        ...
        const handleClick = () => {
            ...
            gsap.to(scrollbar.current || window, {
                scrollTo: {y: 0},
                ...options
            });
        };
    ...
    return (
        <div className="scroll-to-top" ref={scroll} >
            <svg version="1.1" xmlns="http://www.w3.org/2000/svg" ref={svg}
                 xmlnsXlink="http://www.w3.org/1999/xlink"
                 x="0px" y="0px"
                 viewBox="0 0 174 173" xmlSpace="preserve">
		...
		C92,5.1,91.2,6.5,91.1,8.3z"/>
                    <path className="st0" d="M106.4,5.5l1.9,0.5l-2,7.7l4.2,1.1l-0.6,1.5l-5.8-1.5L106.4,5.5z"/>
                    <path className="st0" d="M120,9.7l1.8,0.8l-3.3,7.3l3.9,1.7l-0.8,1.4l-5.5-2.5L120,9.7z"/>
                    <path className="st0"
		...
		C151.5,34.5,149.9,34.9,148.5,36.1z"/>
		 ...
		 M158,49.2l0.6,1.1c0.5,0.9,1.1,1.3,2.1,0.8c0.8-0.4,0.9-1.2,0.4-2.1l-0.6-1.2L158,49.2z"/>
                    <path className="st0" d="M165.5,72.8l-1.6,0.3l-0.7-3.6l1.6-0.3L165.5,72.8z"/>
		...
		C155.4,134.7,154.6,133.3,153.1,132.2z"/>
                    <path className="st0" d="M147.2,146.6l-1.4,1.3l-5.4-5.9l-3.1,2.9l-0.9-1.3l4.4-4.1L147.2,146.6z"/>
                    <path className="st0" d="M136.4,155.7l-1.6,1.1l-4.4-6.7l-3.6,2.3L126,151l5-3.3L136.4,155.7z"/>
                    <path className="st0"
		...
		C98.4,168.7,98.9,167.2,98.7,165.4z"/>
		 ...
		 M82.5,166.2l-1.3-0.1c-1-0.1-1.7,0.2-1.8,1.3c-0.1,1,0.5,1.4,1.5,1.5l1.3,0.1L82.5,166.2z"/>
                    <path className="st0" d="M58.6,159.8l0.6-1.5l3.4,1.3l-0.6,1.5L58.6,159.8z"/>
		...
		L22.9,129.5z M21.6,130.3l-0.8-1.2c-0.5-0.8-1.1-1.3-2-0.7c-0.8,0.5-0.7,1.2-0.3,1.9l0.9,1.5L21.6,130.3z"/>
		 ...
		 M15.4,117.2c1.8-0.7,2.9-1.9,2.4-3.3c-0.6-1.6-2.1-1.6-4-0.9c-1.7,0.6-2.9,1.7-2.3,3.3C12.1,117.7,13.7,117.8,15.4,117.2z"/>
                    <path className="st0" d="M6.5,104.4l-0.3-1.9l7.9-1.4l-0.7-4.2l1.6-0.1l1.1,5.9L6.5,104.4z"/>
                    <path className="st0"
